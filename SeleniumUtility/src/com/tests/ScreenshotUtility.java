...
public class ScreenshotUtility implements ITestListener{	
	...
	public void captureScreenShot(ITestResult result, String status){	
		...
		String passfailMethod2 = result.getMethod().getAfterGroups().getClass().getSimpleName().toString();
    	...
    	String destFile = passfailMethod+"-"+passfailMethod2+" - "+dateFormat.format(new Date()) + ".png";
